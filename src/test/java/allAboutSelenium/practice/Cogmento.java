...
public class Cogmento {
    ...
    public void verify() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='email']")).sendKeys("2301050155cse@gmail.com");
        driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Suresh@123");
        driver.findElement(By.xpath("//div[text()='Login']")).click();
        Thread.sleep(5000);

        WebElement element=driver.findElement(By.xpath("(//div[@role='listbox'])[3]"));
        element.click();
        WebElement option=driver.findElement(By.xpath("//div[@role='option']/span[text()='Suresh Siripurapu']"));
